...
/**
 * Decides and returns if a new window should be started. In case the trigger
...
public interface TriggerPolicy<DATA> extends Serializable {
	 ...
	 * 2) excluding last data point: Essentially required for time based
	 *    eviction and delta rules
